...
#     np.array([                                                        [0.15, 0.0, -0.22], [0.2, 0.0, -0.3], [0.15, 0.0, -0.3], [0.1, 0.0, -0.3], [0.05, 0.0, -0.3], [0.0, 0.0, -0.3], [0.05, 0.0, -0.22], [0.1, 0.0, -0.2], [0.15, 0.0, -0.22]]),
...
trot_ctrl_pts = np.array([
    ...
    np.array([[0.0, 0.0, -0.3], [0.05, 0.0, -0.27], [0.1, 0.0, -0.25], [0.15, 0.0, -0.27], [0.2, 0.0, -0.3], [0.15, 0.0, -0.3], [0.1, 0.0, -0.3], [0.05, 0.0, -0.3], [0.0, 0.0, -0.3]]),
    np.array([[0.0, 0.0, -0.3], [0.05, 0.0, -0.27], [0.1, 0.0, -0.25], [0.15, 0.0, -0.27], [0.2, 0.0, -0.3], [0.15, 0.0, -0.3], [0.1, 0.0, -0.3], [0.05, 0.0, -0.3], [0.0, 0.0, -0.3]]),
    np.array([                                                        [0.15, 0.0, -0.27], [0.2, 0.0, -0.3], [0.15, 0.0, -0.3], [0.1, 0.0, -0.3], [0.05, 0.0, -0.3], [0.0, 0.0, -0.3], [0.05, 0.0, -0.27], [0.1, 0.0, -0.25], [0.15, 0.0, -0.27]]),
])
